            ...
            if form.data['lieu'] == "Litière":
                ...
                if  animal.etat == 'Affamé':
                    if animal.lieu.disponibilite == 'Libre':
                        ...
                        return render(request, "animalerie/animal_detail.html", {'message': f"Désolé la mangeoire est occupée."})
                ...
                if animal.etat == 'Repus':
                    if animal.lieu.disponibilite == 'Libre':
                        ...
                        return render(request, "animalerie/animal_detail.html", {'message': f"Désolé la roue est occupée."})
                else :
                ...
                if animal.etat == 'Fatigué':
                    if animal.lieu.disponibilite == 'Libre':
                        ...
                        return render(request, "animalerie/animal_detail.html", {'message': f"Désolé le nid est occupé."})
                else :
